...
4. Fast (Visit our [benchmark](./benchmark.md) page for more details)

To see the list of options, you can refer to the [options page](./options.md).
...
An example usage is shown in the code snippet above. To see a full list of options, you can refer to the [options page](./options.md).
